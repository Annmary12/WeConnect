...
describe('User Actions Test', () => {
  ...
  describe('fetch a user', () => {
    ...
    it('creates GET_USER_FAILURE after failed to fetch a user', (done) => {
      moxios.wait(() => {
  ...
  describe('get users business(es)', () => {
    it('creates USER_BUSINESSES_SUCCESS after successfuly fetch a user\'s business(es)', (done) => {
  ...
  describe('Update User', () => {
    it('creates USER_UPDATE_SUCCESSFUL after successfully updated a user', (done) => {
    ...
    it('creates USER_BUSINESSES_FAILURE after failed to update a user', (done) => {
      moxios.wait(() => {
        const request = moxios.requests.mostRecent();
        request.respondWith({
          status: 400,
